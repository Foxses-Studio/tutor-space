...
export default function Marquee() {
  return (
    <div className="w-full bg-[#fafafa] border-y border-zinc-100 py-6 overflow-hidden relative select-none z-10 transform -rotate-[5deg] scale-[1.02] origin-center my-6">
