    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center bg-[#121212]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-base font-bold text-zinc-400">Loading batch details...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="container mx-auto px-6 py-8 pb-16">
      ...
      <div className="bg-[#18181b] border border-zinc-800 rounded-lg overflow-hidden shadow-sm">
        <div className="px-6 py-5 bg-[#141416] border-b border-zinc-800 flex items-center gap-2.5 select-none">
          ...
          <h1 className="text-xl font-bold text-white">Update Intake Batch</h1>
        </div>
        ...
        <form onSubmit={handleUpdateBatch} className="p-8 space-y-6">
          ...
          <div className="space-y-1.5">
            <label className="text-base font-bold text-zinc-450 block select-none">Designated Course (Static)</label>
            <input
              type="text"
              disabled
              value={selectedCourseTitle}
              className="w-full bg-[#141416] border border-zinc-850 rounded-lg px-4 py-3.5 text-base font-semibold text-zinc-500 cursor-not-allowed"
            />
          </div>
