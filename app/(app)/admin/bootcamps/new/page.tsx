...
export default function CreateBootcampPage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        console.error('Failed to load courses for bootcamp creation:', err)
      } finally {
        setLoading(false)
      }
    }
  ...
  const handleSaveBootcamp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && (data.success || data.bootcamp)) {
        setSuccessMsg('Intensive Bootcamp designed and launched successfully. Redirecting...')
        setTimeout(() => {
    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center bg-[#121212]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-base font-bold text-zinc-400">Loading Bootcamp creation form...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="container mx-auto px-6 py-8 pb-16">
      ...
      <div className="bg-[#18181b] border border-zinc-800 rounded-lg overflow-hidden shadow-sm">
        <div className="px-6 py-5 bg-[#141416] border-b border-zinc-800 flex items-center gap-2.5 select-none">
          ...
          <h1 className="text-xl font-bold text-white">Design Course Bootcamp</h1>
        </div>

        <form onSubmit={handleSaveBootcamp} className="p-8 space-y-6">
          ...
          <div className="space-y-1.5">
            <label className="text-base font-bold text-zinc-350 block select-none">Bootcamp Title *</label>
            <input
              type="text"
              required
              value={bootcampTitle}
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-[#121212] border border-zinc-800 focus:border-[#615fff]/60 rounded-lg px-4 py-3.5 text-base font-semibold text-white outline-none placeholder-zinc-650 resize-none"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-1.5">
              <label className="text-base font-bold text-zinc-350 block select-none">Booking Price (BDT) *</label>
              <input
                type="number"
                required
                min={0}
          ...
          <div className="pt-4 border-t border-zinc-800 select-none">
            ...
            >
              ...
              <span>Design Bootcamp Event</span>
            </button>
          </div>
